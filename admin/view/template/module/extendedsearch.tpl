  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		...
		<a href="http://www.opencart.com/index.php?route=extension/extension&filter_username=AlexDW" target="_blank" data-toggle="tooltip" title="Get more extensions" class="btn btn-info"><i class="fa fa-download"></i> More extensions</a></span>
